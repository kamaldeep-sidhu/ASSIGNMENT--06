...
class TestMortgagePaymentCalculation(unittest.TestCase):
  ...
  ## __repr__ tests:
class TestMortgageRepr(unittest.TestCase):    
      def test_repr_(self):
            ...
            mortgage = Mortgage(loan_amount, rate, frequency, amortization)
            expected = "[682912.43, 0.0589, 12, 30]"
            actual = repr(mortgage)
            self.assertEqual(actual, expected)
        
      def test_monthly_payment_str(self):
            loan_amount = 682912.43
            rate = MortgageRate.FIXED_1
            frequency = MortgageFrequency.MONTHLY
            amortization = 30
      ...
      def test_weekly_payment_str(self):
            loan_amount = 682912.43
            rate = MortgageRate.FIXED_1
            frequency = MortgageFrequency.WEEKLY
            amortization = 30
            ...
            expected = "[682912.43, 0.0589, 30, 52]"
            actual = str(mortgage)
            self.assertEqual(actual, expected)
    
      def test_bi_weekly_payment_str(self):
            loan_amount = 682912.43
            rate = MortgageRate.FIXED_1
            frequency = MortgageFrequency.BI_WEEKLY
            amortization = 30
            ...
            expected = "[682912.43, 0.0589, 30, 26]"
            actual = str(mortgage)
            self.assertEqual(actual, expected)     
